...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/bookmarks` | `/bookmarks` | `/(tabs)/category` | `/category` | `/(tabs)/login` | `/login` | `/(tabs)/profile` | `/profile` | `/(tabs)/Home` | `/Home` | `/(tabs)/cart` | `/cart` | `/(tabs)/Listings` | `/Listings`;
  // prettier-ignore
